...
- **Home page after sign in**:
  ...
  - Floating trending study songs link at the bottom-right corner.
  - Floating study-session video link at bottom-left.
- **Workspace page**:
  - Dashboard tab (tasks)
  - Reports tab (daily / weekly / monthly)
- Settings tab (theme, wallpaper, tune, custom durations, logout)
...
- Quick link to trending study songs
...
> Note: The app links out to external study/trending video pages and keeps all app data in local browser storage.
